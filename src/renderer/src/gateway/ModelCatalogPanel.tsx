...
export function ModelCatalogPanel(): React.JSX.Element | null {
  ...
  return createPortal(<div className="gw-mask" onClick={close}><section className="gw-panel gw-catalog" role="dialog" aria-modal="true" aria-label="模型管理" onClick={(e) => e.stopPropagation()}>
